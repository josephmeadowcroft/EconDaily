    ...
    var getPTValue = function getPTValue2() {
      ...
      var getPTClassValue = function getPTClassValue2() {
        ...
        if (Array.isArray(value2)) {
          return {
            className: classNames.apply(void 0, _toConsumableArray(value2))
          };
        }
        ...
        if (value2 !== null && value2 !== void 0 && value2.hasOwnProperty("className") && Array.isArray(value2.className)) {
          return {
            className: classNames.apply(void 0, _toConsumableArray(value2.className))
          };
        }
        return value2;
      };
...
var _usePT = function _usePT2(pt, callback, key, params) {
  ...
  if (pt !== null && pt !== void 0 && pt.hasOwnProperty("_usept")) {
    ...
    }) : _objectSpread(_objectSpread({}, originalValue), value2) : value2;
  }
  return fn(pt);
};
var getGlobalPT = function getGlobalPT2() {
  return _getPT(ComponentBase.context.pt || PrimeReact.pt, void 0, function(value2) {
...
var ProgressBar = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React2.createElement("div", _extends({
      id: props.id,
      ref: elementRef
    }, rootProps), React2.createElement("div", valueProps, label != null && React2.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React2.createElement("div", _extends({
      id: props.id,
      ref: elementRef
    }, rootProps), React2.createElement("div", containerProps, React2.createElement("div", valueProps)));
  };
