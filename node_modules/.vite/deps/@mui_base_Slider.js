...
var sliderClasses = generateUtilityClasses2(COMPONENT_NAME, ["root", "active", "focusVisible", "disabled", "dragging", "marked", "vertical", "trackInverted", "trackFalse", "rail", "track", "mark", "markActive", "markLabel", "markLabelActive", "thumb"]);
...
var _excluded2 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React16.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime3.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime2.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime2.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime3.jsxs)(React16.Fragment, {
        children: [(0, import_jsx_runtime2.jsx)(Mark, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime2.jsx)(MarkLabel, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (0, import_jsx_runtime3.jsxs)(Thumb, _extends({
        "data-index": index
        ...
        children: [(0, import_jsx_runtime2.jsx)(Input, _extends({
          ...
          value: values[index]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime2.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index,
          disabled
        }, valueLabelProps, {
...
true ? Slider.propTypes = {
  ...
  slotProps: import_prop_types4.default.shape({
    ...
    valueLabel: import_prop_types4.default.oneOfType([import_prop_types4.default.any, import_prop_types4.default.func])
  }),
  /**
...
@mui/utils/index.js:
   ...
   *)
*/
//# sourceMappingURL=@mui_base_Slider.js.map
