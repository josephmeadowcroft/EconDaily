...
export function Results() {
  ...
  return (
    <div className="w-full h-[calc(100vh-7rem)] bg-primary absolute top-20 flex flex-col gap-8 justify-around items-start md:items-center">
      <div>
        <Countdown />
      ...
      <div className="flex flex-row gap-12 ">
        <div
          className={`h-10 w-24 border border-solid border-gray-600 rounded-3xl ${
